...
A development environment version is a notion of collection of specific versions of compiler toolchains + a collection of compatible versions of the 3rd party dependencies. Currently swblocks-baselib library officially supports two development environment versions - devenv3 (latest) and devenv2 (old) with the devenv2 environment of course to be eventually depreciated in the somewhat near future (probably within a year or so). Here are the collections of the compiler toolchains versions and the 3rd party dependencies versions for each development environment:
...
* **devenv3** for Windows (Win7 - Win10, including latest Win10 creator's edition, SDK 8.1 and 10), vc14 (VS 2015) can be downloaded from [here](https://storage.swblocks.net/devenv/3/windows-x64/dist-devenv3-windows.zip); or from command line:  
wget https://storage.swblocks.net/devenv/3/windows-x64/dist-devenv3-windows.zip
* **devenv3** for Windows both x64 and x86 (Win7 - Win10, including latest Win10 creator's edition, SDK 8.1 and 10), vc14 (VS 2015) can be downloaded from [here](https://storage.swblocks.net/devenv/3/windows-full/dist-devenv3-windows-x64-and-x86.zip); or from command line:  
wget https://storage.swblocks.net/devenv/3/windows-full/dist-devenv3-windows-x64-and-x86.zip
* **devenv3** for Darwin (d156 - 15.x - 16.x, El Capitan and macOS Sierra), clang 7.3, libc++ can be downloaded [here](https://storage.swblocks.net/devenv/3/darwin-elc/dist-devenv3-darwin-15.6.tar.gz); or from command line:  
wget https://storage.swblocks.net/devenv/3/darwin-elc/dist-devenv3-darwin-15.6.tar.gz
* **devenv3** for Ubuntu x64 16.04 LTS with GCC 6.3 and Clang 3.9 can be downloaded [here](https://storage.swblocks.net/devenv/3/ub16-x64/dist-devenv3-ub16-gcc630-clang391.tar.gz); or from command line:  
wget https://storage.swblocks.net/devenv/3/ub16-x64/dist-devenv3-ub16-gcc630-clang391.tar.gz
* **devenv3** for Ubuntu x86 16.04 LTS with GCC 6.3 can be downloaded [here](https://storage.swblocks.net/devenv/3/ub16-x86/dist-devenv3-ub16-x86-gcc630.tar.gz); or from command line:  
wget https://storage.swblocks.net/devenv/3/ub16-x86/dist-devenv3-ub16-x86-gcc630.tar.gz
* **devenv3** for RedHat 6 / CentOS 6 with GCC 6.3 can be downloaded [here](https://storage.swblocks.net/devenv/3/rhel6-x64/dist-devenv3-rhel6.tar.gz); or from command line:  
wget https://storage.swblocks.net/devenv/3/rhel6-x64/dist-devenv3-rhel6.tar.gz

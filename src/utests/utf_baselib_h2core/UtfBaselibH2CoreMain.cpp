...
#define UTF_TEST_MODULE utf_baselib_h2core
#include <utests/baselib/UtfMain.h>

/*
 * The sans-I/O HTTP/2 protocol core: the frame codec, HPACK and Huffman against the RFC 7541
 * Appendix C vectors, flow control, stream states, and Session conformance as byte scripts
 * including every limit of the design's 4.6 - see notes/plans/http2-design.md 8.1 (D20)
 *

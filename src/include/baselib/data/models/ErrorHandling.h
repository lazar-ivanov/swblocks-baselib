...
namespace bl
{
    namespace dm
    {
        ...
        BL_DM_DEFINE_CLASS_BEGIN( ExceptionProperties )
            ...
            BL_DM_DECLARE_STRING_PROPERTY( hint )
            BL_DM_DECLARE_STRING_PROPERTY( originalType )
            BL_DM_DECLARE_STRING_PROPERTY( originalThreadName )
            BL_DM_DECLARE_STRING_PROPERTY( originalStackTrace )
            BL_DM_DECLARE_INT_PROPERTY( serviceStatus )
            BL_DM_DECLARE_INT_PROPERTY( serviceStatusCategory )
            BL_DM_DECLARE_STRING_PROPERTY( serviceStatusMessage )
            BL_DM_DECLARE_STRING_PROPERTY( errorUuid )
            ...
            BL_DM_PROPERTIES_IMPL_BEGIN()
                ...
                BL_DM_IMPL_PROPERTY( hint )
                BL_DM_IMPL_PROPERTY( originalType )
                BL_DM_IMPL_PROPERTY( originalThreadName )
                BL_DM_IMPL_PROPERTY( originalStackTrace )
                BL_DM_IMPL_PROPERTY( serviceStatus )
                BL_DM_IMPL_PROPERTY( serviceStatusCategory )
                BL_DM_IMPL_PROPERTY( serviceStatusMessage )
                BL_DM_IMPL_PROPERTY( errorUuid )
        ...
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, hint )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, originalType )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, originalThreadName )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, originalStackTrace )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, serviceStatus )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, serviceStatusCategory )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, serviceStatusMessage )
        BL_DM_DEFINE_PROPERTY( ExceptionProperties, errorUuid )

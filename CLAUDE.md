...
- **Technical reference belongs near the code.** Build system details, platform-specific documentation, and implementation internals go in the CLAUDE.md closest to the code they describe (e.g., `scripts/devenv7/CLAUDE.md`).
...
**Cross-compilation (Windows devenv7+):** Use `ARCH=` parameter (e.g., `make -k -j4 ARCH=x64`). Supported values: `a64` (ARM64), `x64`, `x86`. See `scripts/devenv7/CLAUDE.md` for details.
...
See `scripts/devenv7/CLAUDE.md` for detailed setup instructions, script variants, and PATH configuration.

---

## Technical Reference

For detailed build system documentation, see `scripts/devenv7/CLAUDE.md`:
...
**Changelog:**
- v2.0 (2026-02-11): Major restructuring — condensed from ~1,700 lines to under 500 lines. Added meta-rules. Moved technical reference to `scripts/devenv7/CLAUDE.md`.
